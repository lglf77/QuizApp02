...
public class Main2ActivitySec1 extends AppCompatActivity {
    ...
    public void showResult(){
        ...
        Bundle b = new Bundle();
        b.putInt("scoreCompFunda", score); // Sua pontuação
        b.putString("section", tableName); // O nome da sua tablea
        ...
        intent.putExtras(b); // Coloque sua pontuação em seu próximo intent
    ...
    public void onBackPressed() {
        ...
        builder.setMessage("Se você fechar, todo o seu progresso não será salvo ... Deseja sair?")
                .setCancelable(false)
