package com.lglf77.quizapp02.LeaderBoard.OS;
...
import com.lglf77.quizapp02.Adapter.LeaderBoardSec2E;
...
public class LeaderBoardAcSec2E extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leader_board_ac_sec2_e);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(LeaderBoardAcSec2E.this,
