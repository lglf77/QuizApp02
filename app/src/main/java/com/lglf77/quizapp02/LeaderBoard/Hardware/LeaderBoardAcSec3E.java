package com.lglf77.quizapp02.LeaderBoard.Hardware;
...
import com.lglf77.quizapp02.Adapter.LeaderBoardSec3E;
...
public class LeaderBoardAcSec3E extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leader_board_ac_sec3_e);
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    Toast.makeText(LeaderBoardAcSec3E.this,
                            "O usuário está desconectado", Toast.LENGTH_SHORT).show();
                    // User is signed out
                }
            }
        };
